...
const BASE = path.join(ROOT, 'docs', 'research', 'kanji-translated-1000-stage3-ko.csv');
const REVIEW300 = path.join(ROOT, 'docs', 'research', 'kanji-translated-300-reviewed.csv');
const OUT = path.join(ROOT, 'docs', 'research', 'kanji-translated-1000-stage4-merged300.csv');
...
const revRows = parseCsv(await fs.readFile(REVIEW300,'utf8'));
const h = baseRows[0];
