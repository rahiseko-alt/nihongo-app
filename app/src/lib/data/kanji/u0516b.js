...
//   出典: http://kanjivg.tagaini.net  (kanji/0516b.svg)
// viewBox: 0 0 109 109（KanjiVG 標準）
// 書き順は KanjiVG 正規順（自動抽出）
// 動作語: 未取得（PDF を確認して songFragment / songLyric を手書きで埋めること）
export const KANJI_U0516B = {
  char: '八',
  reading: 'はち',
  meaning: 'eight',
  word: '八',
      meanings: { en: 'eight', ko: '여덟', vi: 'tám', ne: 'आठ' },
  strokeCount: 2,
  viewBox: '0 0 109 109',
