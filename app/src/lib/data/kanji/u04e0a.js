...
//   出典: http://kanjivg.tagaini.net  (kanji/04e0a.svg)
// viewBox: 0 0 109 109（KanjiVG 標準）
// 書き順は KanjiVG 正規順（自動抽出）
// 動作語: 未取得（PDF を確認して songFragment / songLyric を手書きで埋めること）
export const KANJI_U04E0A = {
  char: '上',
  reading: 'うえ',
  meaning: 'up',
  word: '上',
      meanings: { ja: 'up', en: 'up', vi: 'trên', ne: 'माथि' },
  strokeCount: 3,
  viewBox: '0 0 109 109',
