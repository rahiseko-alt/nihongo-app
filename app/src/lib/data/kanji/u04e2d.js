...
//   出典: http://kanjivg.tagaini.net  (kanji/04e2d.svg)
// viewBox: 0 0 109 109（KanjiVG 標準）
// 書き順は KanjiVG 正規順（自動抽出）
// 動作語: 未取得（PDF を確認して songFragment / songLyric を手書きで埋めること）
export const KANJI_U04E2D = {
  char: '中',
  reading: 'なか',
  meaning: 'middle',
  word: '中',
      meanings: { en: 'middle', ko: '가운데', vi: 'giữa', ne: 'बीच' },
  strokeCount: 4,
  viewBox: '0 0 109 109',
